    ...
    >
      ...
      <div className="">
        ...
        <div className="flex items-center justify-center sm:justify-between flex-col sm:flex-row pt-[72px] min-h-svh px-5 sm:px-16">
          <article className="z-10 lg:text-6xl md:text-5xl text-4xl">
            ...
            <p className="mt-2 sm:mt-3 w-3/4 text-[#ccc] max-w-prose text-base sm:text-lg">
            ...
            <Button className="mt-8 sm:mt-16 bg-[#D7D722] flex gap-2 items-center text-black px-5 py-6 text-xs sm:text-lg shadow-xl">
